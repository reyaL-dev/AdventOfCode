    ...
    public static int countPatternOccurrences(char[][] matrix, String pattern)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < cols; j++)
            {
                ...
                // Horiontal search
                if (j <= cols - pattern.length())
                {
                    if (checkHorizontal(matrix, i, j, pattern))
                    {
                        count++;
                    }
                }
                // Vertical search
                if (j <= rows - pattern.length())
                {
                    if (checkVertical(matrix, i, j, pattern))
                    {
                        count++;
                    }
                }
                // Diagonal Desc Search
                ...
                // Diagonal Asc Search
                if ((j >= pattern.length() - 1) && (i <= cols - pattern.length()))
                {
                    if (checkDiagonalAsc(matrix, i, j, pattern))
                    {
                        count++;
                    }
                }
