package com.reyaldev.aoc.downloader;
...
public class Downloader
{
    ...
    public Downloader(String sessionId, int year, String targetpath)
    {
    ...
    public void downloadInputs()
    {
        ...
        IntStream.rangeClosed(1, 25)
                ...
                .forEach(i -> {
                    try
                    {
                        var target = new File(String.format(targetpath + "/input-%02d.txt", i));
                        if (!target.exists())
                        {
